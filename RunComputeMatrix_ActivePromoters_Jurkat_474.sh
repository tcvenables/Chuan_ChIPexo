...
cd $SLURM_SUBMIT_DIR
module load python 
computeMatrix scale-regions -b 2000 -a 2000 -m 2000 -bs 100 -R Jurkat_ActivePromoters_Filt.bed -S 474-1_22Jan2022_filtchrSort.fx.dupr.NameSort.frag.cleanNORMsort.bw \
...
474-12_22Jan2022_filtchrSort.fx.dupr.NameSort.frag.cleanNORMsort.bw --skipZeros -o 474_Jurkat_ActivePromoters_Filt_ScaleRegions.gz -p 6


plotHeatmap -m 474_Jurkat_ActivePromoters_Filt_ScaleRegions.gz -o 474_Jurkat_ActivePromoters_Filt.png --outFileSortedRegions 474_Jurkat_ActivePromoters_Filt_SortedRegions --outFileNameMatrix 474_Jurkat_ActivePromoters_Filt_NameMatrix
