...
cd $SLURM_SUBMIT_DIR
module load python 
computeMatrix reference-point --referencePoint center -b 2000 -a 2000 -bs 100 -R Jurkat_PoisedPromoters_Filt.bed -S 474-1_22Jan2022_filtchrSort.fx.dupr.NameSort.frag.cleanNORMsort.bw \
...
474-12_22Jan2022_filtchrSort.fx.dupr.NameSort.frag.cleanNORMsort.bw --skipZeros -o 474_Jurkat_PoisedPromoters_Filt.gz -p 6


plotHeatmap -m 474_Jurkat_PoisedPromoters_Filt.gz -o 474_Jurkat_PoisedPromoters_Filt.png --outFileSortedRegions 474_Jurkat_PoisedPromoters_Filt_SortedRegions --outFileNameMatrix 474_Jurkat_PoisedPromoters_Filt_NameMatrix
